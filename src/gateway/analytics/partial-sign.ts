...
import {ConfirmFailureAnalyticData, PartialSignAnaliticData} from "../../common/analitics-reporter";
...
router.use('/report', asyncHandler(async (req, res, next) => {
  let {timestamp, signature, wallet, ...otherReportData} = req.body as PartialSignAnaliticData
