...
const SpiritApp = dynamicExtend(
  class {},
  require('../general/spirit_permissionless_oracles_vwap_v2')
)
...
const testLP = async () => {
  ...
  return app
    .onRequest({
      ...
      data: {
        params: {
          token: '0xF42dBcf004a93ae6D5922282B304E2aEFDd50058', // vAMM-DEI/DEUS
          chainId: '250',
          pairs0: [
            {
              exchange: 'solidly',
...
const testPrice = async () => {
  ...
  return app
    .onRequest({
      ...
      data: {
        params: {
          token: '0xDE5ed76E7c05eC5e4572CfC88d1ACEA165109E44', // DEUS
          pairs: [
            {
              exchange: 'solidly',
              chainId: '250',
